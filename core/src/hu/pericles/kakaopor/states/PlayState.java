...
public class PlayState extends State implements InputProcessor {
    ...
    /*TEXTURES*/
    private Texture[] baseLevelTexture = new Texture[NUMBER_OF_LEVEL];
    private Texture[] turretTowerLevelTexture = new Texture[NUMBER_OF_LEVEL];
    private Texture[] turretBaseLevelTexture = new Texture[NUMBER_OF_LEVEL];
    private Texture[] trapLevelTexture = new Texture[NUMBER_OF_LEVEL];
    //private Texture[] wallLevelTexture = new Texture[NUMBER_OF_LEVEL];
    ...
    /*GAME CONSTANTS*/
    private static  final int NUMBER_OF_LEVEL = 6;
    ...
    PlayState(GameStateManager gameStateManager) {
        ...
        for (int i = 0; i < NUMBER_OF_ENEMY; i++) {
            enemy[i] = new Enemy(startX, startY, 5, 25 ,10);
